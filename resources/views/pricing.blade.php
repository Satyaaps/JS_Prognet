				...
				<ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
					 ...
					 <li>
						...
						<ul class="sub-menu" style="display: none;">
							<li>
								<a href="{{ route('pricing') }}" class="active"> 
					...
					<li>
						...
						<ul class="sub-menu" style="display: none;">
							...
							<li>
								<a href="{{ route('blog-single-post') }}">Blog Single</a>
							</li> 
						</ul>
					</li> 
					<li class="last">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card p-4 mb-4">
                    <h6 class="mb-4">Can I use this template for commercial?</h6>
                     <p class="text-muted">Lorem ipsum dolor sit amet, consectetur fugit inventore ipsam iure laudantium molestiae.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card p-4 mb-4">
                    <h6 class="mb-4">How many licenses are there?</h6>
                     <p class="text-muted">Lorem ipsum dolor sit amet, consectetur fugit inventore ipsam iure laudantium molestiae.</p>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="card p-4 mb-4">
                    <h6 class="mb-4">Can I use it for multiple clients?</h6>
                     <p class="text-muted">Lorem ipsum dolor sit amet, consectetur fugit inventore ipsam iure laudantium molestiae.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card p-4 mb-4">
                    <h6 class="mb-4">Do I get a working contact form?</h6>
                    <p class="text-muted">Lorem ipsum dolor sit amet, consectetur fugit inventore ipsam iure laudantium molestiae.</p>
                </div>
            </div>
                <div class="col-md-6">
